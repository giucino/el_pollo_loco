...
function generateBackgroundObjects(count) {
    return [
        ...
        ...Array(count).fill().map((_, i) => new BackgroundObject(`img/5_background/layers/2_second_layer/${i % 2 === 0 ? '2' : '1'}.png`, -2876 + (719 * i), 0.4)),
        ...Array(count).fill().map((_, i) => new BackgroundObject(`img/5_background/layers/1_first_layer/${i % 2 === 0 ? '2' : '1'}.png`, -2876 + (719 * i), 0.5))
    ];
}
